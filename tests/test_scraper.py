...
class TestScraperFunctionality:
    ...
    def test_table_view_scraper_endpoint_exists(self, client, app, user):
        ...
        assert response.status_code in [200, 400], f"Got {response.status_code}, expected 200 or 400"
    ...
    def test_scraper_handles_ebay_url(self, client, app, user):
        ...
        assert 'error' in data or 'title' in data or 'name' in data, \
            "Response should have error or product data"
